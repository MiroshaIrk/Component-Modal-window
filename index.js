  ...
  <div class="col" style="max-width: 400px">
    <div class="card">
      <img src="${fruit.img}" class="card-img-top"
        style="height: 300px;" alt="${fruit.title}">
      <div class="card-body">
...
function render() {
  const html = fruits.map(fruit => toHTML(fruit)).join(''); // const html = fruits.map(toHTML); улутшенный синтаксис ECMA 6
...
document.addEventListener('click', event => {
  ...
  if (btnType === 'price') {
    ...
    <p>Цена на ${fruit.title}: <strong>${fruit.price}$</strong>`)
    priceModal.open();
